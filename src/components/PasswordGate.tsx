...
const CORRECT_ANSWER = 'Sara';
const CORRECT_HASH = '3a6d64c24cf80b69ccda37650406467e8266667b50cfd0b984beb3651b129ed7';

const RIDDLE = "Aapki aur sabki aankhon ka tara, vo sabse pyaari, uska naam...";
